  ...
  const emailOptions = {
    ...
    <![endif]-->
      ...
      <![endif]-->
        ...
        <tbody>
          <tr>
            <td style="padding:21px 14px 18px 14px; line-height:30px; text-align:inherit; background-color:#e5fbfe;" height="100%" valign="top" bgcolor="#e5fbfe" role="module-content"><div><div style="font-family: inherit"><strong>¡Hola! Muchas gracias por tu interés en TECHO. Estamos revisando los perfiles y el tuyo nos pareció muy interesante. Nos gustaría conocerte para contarte más de la oportunidad y conocer tus intereses. ¿Qué disponibilidad tendrías para coordinar una entrevista?</strong>&nbsp;</div><div></div></div></td>
          </tr>
        </tbody>
      ...
      </table><table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns" style="padding:0px 0px 0px 0px;" bgcolor="#E5FBFE" data-distribution="1">
        <tbody>
          <tr role="module-content">
          ...
          <tbody>
            <tr>
              <td style="padding:0px;margin:0px;border-spacing:0;"><table class="module" role="module" data-type="social" align="center" border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout: fixed;" data-muid="0ca738c7-d11c-4e8d-b6e6-9f8b4f3a4de6">
        <tbody>
          <tr>
            <td valign="top" style="padding:15px 0px 0px 0px; font-size:6px; line-height:10px; background-color:E5FBFE;" align="center">
              <table align="center" style="-webkit-margin-start:auto;-webkit-margin-end:auto;">
                <tbody><tr align="center"><td style="padding: 0px 5px;" class="social-icon-column">
          <a role="social-icon-link" href="https://www.facebook.com/techo.org/" target="_blank" alt="Facebook" title="Facebook" style="display:inline-block; background-color:#3B579D; height:31px; width:31px; border-radius:6px; -webkit-border-radius:6px; -moz-border-radius:6px;">
          ...
          <a role="social-icon-link" href="https://twitter.com/techo" target="_blank" alt="Twitter" title="Twitter" style="display:inline-block; background-color:#7AC4F7; height:31px; width:31px; border-radius:6px; -webkit-border-radius:6px; -moz-border-radius:6px;">
          ...
          <a role="social-icon-link" href="https://www.instagram.com/techo_org/" target="_blank" alt="Instagram" title="Instagram" style="display:inline-block; background-color:#7F4B30; height:31px; width:31px; border-radius:6px; -webkit-border-radius:6px; -moz-border-radius:6px;">
